...
import org.mockit.core.{BasicMockType, Configuration}
import org.mockit.logging.{Logger, NetworkLogger, LogChannel}

/**
 * Mock worker instance for [[org.mockit.mock.http.HttpClientMockUnit]].
 *
 * Opens a socket to the target server and executes the requests stored
 * in the [[org.mockit.mock.http.HttpClientMockUnit]]. Every response
