...
import com.github.pheymann.mockit.network.{ShutdownServer, UploadServer, LogServer}
...
object MockFactory {
    ...
    /**
     * Creates and runs a local instance of the [[com.github.pheymann.mockit.core.MockAgent]].
     *
     * @param mockUnits
     *                  collection of [[com.github.pheymann.mockit.mock.MockUnit]]s and their
     *                  [[com.github.pheymann.mockit.core.Configuration]]s
    ...
    /**
     * Creates and runs an local instance of the [[com.github.pheymann.mockit.core.MockAgent]]
    ...
    /**
      ...
      *
      * Requirements:
      *  - all necessary [[com.github.pheymann.mockit.core.MockAgent]]s are available
      *
      * Server-Instances:
      *  - [[com.github.pheymann.mockit.network.UploadServer]]
      *  - [[com.github.pheymann.mockit.network.InvitationServer]]
      *  - [[com.github.pheymann.mockit.network.LogServer]]
      *  - [[com.github.pheymann.mockit.network.ShutdownServer]]
      *
      * @param mockUnits
      *                  collection of [[com.github.pheymann.mockit.mock.MockUnit]]s and their
      *                  [[com.github.pheymann.mockit.core.Configuration]]s
      * @param components
      *                  all depending class definitions used by the [[com.github.pheymann.mockit.mock.MockUnit]]s
      * @param serverIps
      *                  holds all ips, of the [[com.github.pheymann.mockit.mock.MockUnit]]s which behave as
