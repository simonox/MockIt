...
import org.mockit.core.{MockFactory, MockUnitContainer}
import org.mockit.logging.Logger
import org.mockit.networkclassloader.NetworkClassServer
...
/**
 * Server instance to send class files and configurations to [[org.mockit.core.MockAgent]]s
 * which received an invitation send by [[org.mockit.network.InvitationServer]].
 *
 * One [[org.mockit.mock.MockUnit]] gets send to exactly one agent with all
